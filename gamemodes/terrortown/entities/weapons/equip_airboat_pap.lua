...
local damageMultCvar = CreateConVar("ttt_detective_toy_car_damage_mult_pap", 2.5, {FCVAR_NOTIFY, FCVAR_REPLICATED}, "Damage multiplier the detective car takes", 0, 10)

local placeRangeCvar = CreateConVar("ttt_detective_toy_car_place_range_pap", 200, {FCVAR_NOTIFY, FCVAR_REPLICATED}, "The maximum distance the detective car can be placed down", 10, 10000)
