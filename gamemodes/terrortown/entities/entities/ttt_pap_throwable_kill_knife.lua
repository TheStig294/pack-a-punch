...
function ENT:HitPlayer(other, tr)
   ...
   elseif SERVER then
      ...
      -- Just to pass the damage check in the randomat code...
      dmg:SetInflictor(ents.Create("weapon_ttt_impostor_knife_randomat"))
...
if SERVER then
   function ENT:BecomeWeapon()
      ...
      local wep = ents.Create("weapon_ttt_impostor_knife_randomat")
