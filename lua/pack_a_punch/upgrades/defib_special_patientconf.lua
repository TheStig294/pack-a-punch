local UPGRADE = {}
UPGRADE.id = "defib_special_patientconf"
...
UPGRADE.convars = {
    {
        name = "pap_defib_special_patientconf_can_become_paramedic",
        type = "bool"
    }
}

local canBecomeMedCvar = CreateConVar("pap_defib_special_patientconf_can_become_paramedic", "1", {FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED}, "Allow revived players to become paramedics")
