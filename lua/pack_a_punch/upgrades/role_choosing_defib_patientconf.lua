local UPGRADE = {}
UPGRADE.id = "role_choosing_defib_patientconf"
UPGRADE.class = "weapon_patientconf_defib"
UPGRADE.name = "Role Choosing Defib"
UPGRADE.desc = "You can select the innocent role a player becomes!\n(Right-click)"

UPGRADE.convars = {
    {
        name = "pap_role_choosing_defib_patientconf_can_become_paramedic",
        type = "bool"
    }
}

local canBecomeMedCvar = CreateConVar("pap_role_choosing_defib_patientconf_can_become_paramedic", "1", {FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED}, "Allow revived players to become paramedics")
