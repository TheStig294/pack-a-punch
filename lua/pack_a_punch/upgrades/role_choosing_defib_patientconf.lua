...
local canBecomeMedCvar = CreateConVar("pap_role_choosing_defib_patientconf_can_become_paramedic", "1", {FCVAR_NOTIFY, FCVAR_REPLICATED}, "Allow revived players to become paramedics")
