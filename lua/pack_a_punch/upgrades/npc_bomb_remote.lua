...
local radiusCvar = CreateConVar("pap_npc_bomb_remote_radius", "400", {FCVAR_NOTIFY, FCVAR_REPLICATED}, "Explosion radius", 0, 1000)

local damageCvar = CreateConVar("pap_npc_bomb_remote_damage", "1000", {FCVAR_NOTIFY, FCVAR_REPLICATED}, "Explosion damage", 0, 4000)

local triggerRadiusCvar = CreateConVar("pap_npc_bomb_remote_trigger_radius", "100", {FCVAR_NOTIFY, FCVAR_REPLICATED}, "Distance before triggering explosion", 0, 1000)
