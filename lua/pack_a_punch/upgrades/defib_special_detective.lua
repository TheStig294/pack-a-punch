local UPGRADE = {}
UPGRADE.id = "defib_special_detective"
UPGRADE.class = "weapon_detective_defib"
...
local canBecomeMedCvar = CreateConVar("pap_defib_special_detective_can_become_paramedic", "1", {FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED}, "Allow revived players to become paramedics")
