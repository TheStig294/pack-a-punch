...
local damageCvar = CreateConVar("pap_all_stats_up_damage", "1.1", {FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED}, "Firerate multiplier", 1, 10)

local spreadCvar = CreateConVar("pap_all_stats_up_spread", "1.3", {FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED}, "Firerate multiplier", 1, 10)

local ammoCvar = CreateConVar("pap_all_stats_up_ammo", "1.2", {FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED}, "Firerate multiplier", 1, 10)

local recoilCvar = CreateConVar("pap_all_stats_up_recoil", "0.75", {FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED}, "Firerate multiplier", 0, 1)
