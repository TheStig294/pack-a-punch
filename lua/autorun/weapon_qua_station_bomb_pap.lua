...
TTT_PAP_UPGRADES.weapon_qua_station_bomb = {
    name = "Bomb Station Converter",
    desc = "Converts *anything* into a bomb station!",
    func = function(SWEP)
        ...
        hook.Add("TTTPrepareRound", "PAPStationBombReset", function()
        ...
        hook.Add("PlayerPostThink", "PAPStationBomb", function(ply)
        ...
        hook.Add("TTTOnCorpseCreated", "PAPStationBombCorpse", function(rag)
