...
TTT_PAP_UPGRADES.weapon_vam_fangs = {
    ...
    func = function(SWEP)
        ...
        hook.Add("TTTVampireInvisibilityChange", "TTTPAPVampireFangsDisable", function(owner, isActive)
        ...
        hook.Add("SetupMove", "TTTPAPVampireFangsFly", function(ply, moveData, cmd)
        ...
        hook.Add("TTTPrepareRound", "TTTPAPVampireFangsReset", function()
            ...
            hook.Remove("TTTVampireInvisibilityChange", "TTTPAPVampireFangsDisable")
            hook.Remove("SetupMove", "TTTPAPVampireFangsFly")
            hook.Remove("TTTPrepareRound", "TTTPAPVampireFangsReset")
        end)
    end
}